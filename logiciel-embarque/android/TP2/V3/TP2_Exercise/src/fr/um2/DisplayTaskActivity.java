...
public class DisplayTaskActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(getIntent().getAction().toString() == MainActivity.ACTION_NULL){
			
			
		}else if(getIntent().getAction().toString() == MainActivity.ACTION_DATE){
			date = getIntent().getExtras().getString(MainActivity.EXTRA_DATE);
			
		}else if(getIntent().getAction().toString() == MainActivity.ACTION_CATEGORY){
			date = getIntent().getExtras().getString(MainActivity.EXTRA_DATE);
